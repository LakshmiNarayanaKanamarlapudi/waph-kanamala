...
<body>
  <div class="container">
        <h1>Mini Facebook Application</h1>
        <form action="index.php" method="POST" class="form login">
            ...
            <button style= "color:black;" class="button" type="submit">Login here</button>
        </form>

        <form action="registrationform.php" method="GET">
            <button style= "color:black;" type="submit">Create an account</button>
        </form>
    </div>
</body>
</html>
